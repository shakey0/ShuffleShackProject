...
countries = ['Algeria', 'Argentina', 'Australia', 'Australia', 'Austria', 'Bahrain', 'Bangladesh', 'Belarus',
            'Belgium', 'Benin', 'Bolivia', 'Brazil', 'Brunei', 'Bulgaria', 'Burkina Faso', 'Cambodia', 'Cameroon',
            'Canada', 'China', 'China', 'China', 'China', 'China', 'China', 'China', 'China', 'Colombia', 'Croatia',
            'Cyprus', 'Czech Republic', "Côte d'Ivoire", 'DR Congo', 'Denmark', 'Dominican Republic', 'Egypt',
            'El Salvador', 'Eritrea', 'Estonia', 'Ethiopia', 'Finland', 'France', 'France', 'Germany', 'Germany',
            'Ghana', 'Greece', 'Greece', 'Haiti', 'Honduras', 'Hungary', 'Iceland', 'India', 'India', 'Indonesia',
            'Indonesia', 'Iran', 'Iraq', 'Ireland', 'Israel', 'Italy', 'Italy', 'Japan', 'Japan', 'Jordan',
            'Kazakhstan', 'Kenya', 'Kuwait', 'Kyrgyzstan', 'Laos', 'Latvia', 'Lebanon', 'Liberia', 'Libya',
            'Lithuania', 'Luxembourg', 'Madagascar', 'Malaysia', 'Mali', 'Malta', 'Mauritania', 'Mexico', 'Mexico',
            ...
            'Senegal', 'Sierra Leone', 'Singapore', 'Slovakia', 'Slovenia', 'Somalia', 'South Africa', 'South Korea',
            'Spain', 'Spain', 'Spain', 'Spain', 'Spain', 'Spain', 'Sri Lanka', 'Sudan', 'Sweden', 'Switzerland',
            'Syria', 'Tajikistan', 'Tanzania', 'Thailand', 'Thailand', 'Togo', 'Tunisia', 'Turkey', 'Turkmenistan',
            'Uganda', 'Ukraine', 'United Arab Emirates', 'United Kingdom', 'United Kingdom', 'United Kingdom',
            'United Kingdom', 'United Kingdom', 'United Kingdom', 'United States', 'United States', 'United States',
            'United States', 'United States', 'United States', 'Uruguay', 'Uzbekistan', 'Venezuela', 'Vietnam', 'Yemen',
            'Zambia', 'Zimbabwe',
            'Argentina', 'Australia', 'Australia', 'Austria', 'Bahrain', 'Bangladesh', 'Belarus', 'Belgium', 'Benin',
            'Bolivia', 'Brazil', 'Brunei', 'Bulgaria', 'Burkina Faso', 'Cambodia', 'Cameroon', 'Canada', 'China',
            'China', 'China', 'China', 'China', 'China', 'China', 'China', 'Colombia', 'Croatia', 'Cyprus',
            'Czech Republic', "Côte d'Ivoire", 'DR Congo', 'Denmark', 'Dominican Republic', 'Egypt', 'El Salvador',
            'Estonia', 'Ethiopia', 'Finland', 'France', 'France', 'Germany', 'Germany', 'Ghana', 'Greece', 'Greece',
            'Honduras', 'Hungary', 'Iceland', 'India', 'India', 'Indonesia', 'Indonesia', 'Iran', 'Ireland', 'Italy',
            'Italy', 'Japan', 'Japan', 'Jordan', 'Kazakhstan', 'Kenya', 'Kuwait', 'Kyrgyzstan', 'Laos', 'Latvia',
            'Lebanon', 'Liberia', 'Lithuania', 'Luxembourg', 'Malaysia', 'Malta', 'Mauritania', 'Mexico', 'Mexico',
            'Moldova', 'Mongolia', 'Morocco', 'Mozambique', 'Myanmar', 'Nepal', 'Netherlands', 'New Zealand',
            'Nicaragua', 'Niger', 'Nigeria', 'Norway', 'Oman', 'Pakistan', 'Panama', 'Paraguay', 'Peru', 'Philippines',
            'Poland', 'Portugal', 'Qatar', 'Romania', 'Russia', 'Rwanda', 'Saudi Arabia', 'Senegal', 'Sierra Leone',
            'Singapore', 'Slovakia', 'Slovenia', 'South Africa', 'South Korea', 'Spain', 'Spain', 'Spain', 'Spain',
            'Spain', 'Spain', 'Sri Lanka', 'Sudan', 'Sweden', 'Switzerland', 'Syria', 'Tajikistan', 'Tanzania',
            'Thailand', 'Thailand', 'Turkey', 'Turkmenistan', 'Uganda', 'Ukraine', 'United Arab Emirates',
            ...
            'Argentina', 'Australia', 'Australia', 'Austria', 'Belgium', 'Bolivia', 'Brazil', 'Brunei', 'Bulgaria',
            'Cambodia', 'Canada', 'China', 'China', 'China', 'China', 'China', 'China', 'China', 'China', 'Croatia',
            'Cyprus', 'Czech Republic', "Côte d'Ivoire", 'Denmark', 'Dominican Republic', 'Egypt', 'Estonia', 'Finland',
            'France', 'France', 'Germany', 'Germany', 'Ghana', 'Greece', 'Greece', 'Hungary', 'Iceland', 'India',
            'India', 'Indonesia', 'Indonesia', 'Ireland', 'Italy', 'Italy', 'Japan', 'Japan', 'Jordan', 'Kazakhstan',
            'Kenya', 'Laos', 'Latvia', 'Lithuania', 'Luxembourg', 'Malaysia', 'Malta', 'Mexico', 'Mexico', 'Mongolia',
            'Morocco', 'Nepal', 'Netherlands', 'New Zealand', 'Nigeria', 'Norway', 'Oman', 'Pakistan', 'Paraguay',
            'Peru', 'Philippines', 'Poland', 'Portugal', 'Romania', 'Russia', 'Rwanda', 'Saudi Arabia', 'Senegal',
            'Sierra Leone', 'Singapore', 'Slovakia', 'Slovenia', 'South Africa', 'South Korea', 'Spain', 'Spain',
            'Spain', 'Spain', 'Spain', 'Spain', 'Sri Lanka', 'Sweden', 'Switzerland', 'Thailand', 'Thailand', 'Turkey',
            'Turkmenistan', 'Ukraine', 'United Arab Emirates', 'United Kingdom', 'United Kingdom', 'United Kingdom',
            'United Kingdom', 'United Kingdom', 'United Kingdom', 'United States', 'United States', 'United States',
            'United States', 'United States', 'United States', 'Uruguay', 'Uzbekistan', 'Venezuela', 'Vietnam',
            'Zimbabwe']

cities = {
    'Algeria': ['Algiers', 'Oran', 'Constantine'],
    'Argentina': ['Buenos Aires', 'Buenos Aires', 'Buenos Aires', 'Cordoba', 'Rosario', 'Mendoza', 'La Plata', 'San Miguel de Tucuman'],
    'Australia': ['Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Sydney', 'Melbourne', 'Brisbane', 'Adelaide', 'Gold Coast', 'Newcastle', 'Canberra', 'Sunshine Coast', 'Wollongong', 'Hobart', 'Geelong', 'Townsville', 'Cairns', 'Darwin', 'Launceston'],
    'Austria': ['Vienna', 'Vienna', 'Vienna', 'Graz', 'Linz', 'Salzburg', 'Innsbruck', 'Salzburg', 'Innsbruck', 'Klagenfurt', 'Villach', 'Wels', 'Steyr'],
    'Bahrain': ['Manama', 'Muharraq', 'Riffa', 'Hamad Town'],
    'Bangladesh': ['Dhaka', 'Dhaka', 'Chittagong', 'Khulna', 'Rajshahi', 'Comilla'],
    'Belarus': ['Minsk', 'Minsk', 'Gomel', 'Mogilev'],
    'Belgium': ['Brussels', 'Brussels', 'Antwerp', 'Ghent', 'Charleroi', 'Liege', 'Bruges', 'Bruges', 'Bruges', 'Namur'],
    'Benin': ['Cotonou', 'Porto-Novo', 'Parakou'],
    'Bolivia': ['Santa Cruz de la Sierra', 'El Alto', 'La Paz', 'Cochabamba', 'Oruro', 'Sucre', 'Tarija', 'Potosi'],
    'Brazil': ['Sao Paulo', 'Rio de Janeiro', 'Sao Paulo', 'Rio de Janeiro', 'Sao Paulo', 'Rio de Janeiro', 'Salvador', 'Brasilia', 'Fortaleza', 'Belo Horizonte'],
    'Brunei': ['Bandar Seri Begawan', 'Kuala Belait', 'Seria', 'Tutong', 'Bangar'],
    'Bulgaria': ['Sofia', 'Sofia', 'Sofia', 'Plovdiv', 'Varna', 'Burgas', 'Ruse', 'Stara Zagora', 'Pleven', 'Sliven'],
    'Burkina Faso': ['Ouagadougou', 'Bobo-Dioulasso', 'Koudougou'],
    'Cambodia': ['Phnom Penh', 'Battambang', 'Siem Reap', 'Siem Reap', 'Siem Reap', 'Sihanoukville', 'Poipet', 'Kampong Cham', 'Kampong Speu', 'Kampot'],
    'Cameroon': ['Douala', 'Yaounde', 'Garoua'],
    'Canada': ['Toronto', 'Montreal', 'Vancouver', 'Toronto', 'Montreal', 'Vancouver', 'Toronto', 'Montreal', 'Vancouver', 'Calgary', 'Edmonton', 'Ottawa', 'Mississauga', 'Winnipeg', 'Quebec City', 'Hamilton', 'Brampton', 'Surrey', 'Laval', 'Halifax', 'London'],
    'China': ['Shanghai', 'Beijing', 'Shanghai', 'Beijing', 'Shanghai', 'Beijing', 'Tianjin', 'Guangzhou', 'Shenzhen', 'Wuhan', 'Dongguan', 'Hong Kong', 'Hong Kong', 'Hong Kong', 'Chongqing', 'Guilin', 'Yangshuo', 'Guilin', 'Yangshuo', 'Guilin', 'Yangshuo', 'Chengdu', 'Chengdu', 'Nanjing', 'Taipei', 'Nanchong', 'Xi\'an', 'Shenyang', 'Hangzhou', 'Harbin', 'Taiyuan', 'Suzhou', 'Zhengzhou', 'Changsha', 'Dalian', 'Kunming', 'Jinan', 'Qingdao', 'Fuzhou', 'Changchun', 'Xiamen', 'Guiyang', 'Ningbo', 'Lanzhou', 'Nanning', 'Hefei', 'Urumqi', 'Anshan', 'Fushun', 'Nanchang', 'Zibo', 'Qiqihar', 'Jilin City', 'Tangshan', 'Wuxi', 'Shiyan', 'Tianshui', 'Yinchuan', 'Zhangjiakou', 'Yangzhou', 'Zhenjiang', 'Xining', 'Huai\'an', 'Jiaxing', 'Quanzhou', 'Luoyang', 'Nantong', 'Baotou', 'Liuzhou', 'Wenzhou', 'Hohhot', 'Anyang', 'Xiangyang', 'Tai\'an', 'Haikou', 'Zaozhuang', 'Changzhou', 'Dandong', 'Wuhu', 'Handan', 'Taizhou', 'Yantai', 'Bengbu', 'Xuzhou', 'Huainan', 'Huzhou', 'Jining', 'Benxi', 'Datong', 'Yiwu', 'Fuxin', 'Huangshi', 'Liaoyang', 'Ma\'anshan', 'Xinxiang', 'Zhanjiang', 'Zigong', 'Shaoxing', 'Yancheng', 'Zhangzhou', 'Zhangye', 'Jiangmen', 'Zhenzhou', 'Pingdingshan', 'Jinzhou', 'Xiangtan', 'Zhuhai', 'Fuyang', 'Xinyang', 'Lianyungang', 'Wuhai', 'Baoding', 'Puyang', 'Yichang', 'Zhangjiagang'],
    'Colombia': ['Bogota', 'Bogota', 'Bogota', 'Medellin', 'Cali'],
    'Croatia': ['Zagreb', 'Split', 'Rijeka', 'Osijek', 'Zadar', 'Dubrovnik', 'Pula', 'Dubrovnik', 'Pula', 'Dubrovnik', 'Sesvete', 'Karlovac', 'Varazdin'],
    'Cyprus': ['Nicosia', 'Limassol', 'Larnaca', 'Famagusta', 'Paphos'],
    'Czech Republic': ['Prague', 'Prague', 'Prague', 'Brno', 'Ostrava', 'Plzen', 'Liberec', 'Olomouc', 'Usti nad Labem', 'Hradec Kralove'],
    "Côte d'Ivoire": ['Abidjan', 'Bouaké', 'Daloa'],
    'DR Congo': ['Kinshasa', 'Lubumbashi', 'Mbuji-Mayi'],
    'Denmark': ['Copenhagen', 'Copenhagen', 'Copenhagen', 'Aarhus', 'Odense', 'Aalborg', 'Frederiksberg', 'Esbjerg', 'Randers'],
    ...
    'Egypt': ['Cairo', 'Alexandria', 'Giza', 'Cairo', 'Alexandria', 'Giza', 'Cairo', 'Alexandria', 'Giza', 'Shubra El-Kheima', 'Port Said', 'Suez', 'Luxor', 'El-Mahalla El-Kubra', 'Tanta', 'Asyut'],
    'El Salvador': ['San Salvador', 'Soyapango', 'Santa Ana', 'San Miguel'],
    'Eritrea': ['Asmara'],
    'Estonia': ['Tallinn', 'Tallinn', 'Tallinn', 'Tartu', 'Narva', 'Kohtla-Jarve', 'Parnu', 'Viljandi', 'Rakvere', 'Maardu'],
    'Ethiopia': ['Addis Ababa', 'Dire Dawa', 'Mekele'],
    'Finland': ['Helsinki', 'Helsinki', 'Helsinki', 'Espoo', 'Tampere', 'Vantaa', 'Oulu', 'Turku', 'Jyvaskyla', 'Lahti', 'Kuopio', 'Pori'],
    'France': ['Paris', 'Paris', 'Paris', 'Marseille', 'Lyon', 'Toulouse', 'Nice', 'Nantes', 'Strasbourg', 'Montpellier', 'Bordeaux', 'Lille', 'Rennes', 'Reims', 'Le Havre', 'Saint-Etienne', 'Toulon', 'Grenoble', 'Dijon', 'Nimes', 'Angers', 'Villeurbanne'],
    'Germany': ['Berlin', 'Hamburg', 'Munich', 'Cologne', 'Berlin', 'Hamburg', 'Munich', 'Cologne', 'Frankfurt', 'Stuttgart', 'Dusseldorf', 'Dortmund', 'Essen', 'Leipzig', 'Bremen', 'Dresden', 'Hanover', 'Nuremberg', 'Duisburg', 'Bochum', 'Wuppertal', 'Bielefeld', 'Bonn', 'Mannheim'],
    'Ghana': ['Accra', 'Kumasi', 'Tamale'],
    'Greece': ['Athens', 'Athens', 'Athens', 'Thessaloniki', 'Patras', 'Heraklion', 'Larissa', 'Volos', 'Rhodes', 'Ioannina', 'Chania', 'Chalcis', 'Zante', 'Zante'],
    'Haiti': ['Port-au-Prince', 'Carrefour', 'Delmas'],
    'Honduras': ['Tegucigalpa', 'San Pedro Sula', 'Choloma'],
    'Hungary': ['Budapest', 'Budapest', 'Budapest', 'Debrecen', 'Szeged', 'Miskolc', 'Pecs', 'Gyor'],
    'Iceland': ['Reykjavik', 'Reykjavik', 'Reykjavik', 'Kopavogur', 'Hafnarfjordur', 'Akureyri', 'Reykjanesbaer'],
    'India': ['Mumbai', 'Delhi', 'Mumbai', 'Delhi', 'Mumbai', 'Delhi', 'Bangalore', 'Hyderabad', 'Ahmedabad', 'Chennai', 'Kolkata', 'Surat', 'Pune', 'Jaipur', 'Lucknow', 'Kanpur', 'Nagpur', 'Visakhapatnam', 'Indore', 'Thane', 'Bhopal', 'Pimpri-Chinchwad', 'Patna', 'Vadodara'],
    'Indonesia': ['Jakarta', 'Surabaya', 'Jakarta', 'Surabaya', 'Jakarta', 'Surabaya', 'Medan', 'Bandung', 'Bekasi', 'Palembang', 'Tangerang', 'Makassar', 'South Tangerang', 'Semarang', 'Depok', 'Padang', 'Denpasar', 'Bandar Lampung', 'Bogor', 'Malang', 'Pekanbaru', 'Batam', 'Banten', 'Surakarta'],
    'Iran': ['Tehran', 'Mashhad', 'Isfahan'],
    'Iraq': ['Baghdad', 'Basra', 'Mosul'],
    'Ireland': ['Dublin', 'Dublin', 'Dublin', 'Cork', 'Limerick', 'Galway', 'Waterford', 'Drogheda', 'Dundalk', 'Swords', 'Bray', 'Navan'],
    'Israel': ['Jerusalem', 'Tel Aviv', 'Haifa'],
    'Italy': ['Rome', 'Milan', 'Naples', 'Rome', 'Milan', 'Naples', 'Rome', 'Milan', 'Naples', 'Turin', 'Palermo', 'Genoa', 'Bologna', 'Florence', 'Bari', 'Catania', 'Venice', 'Verona', 'Messina', 'Padua', 'Trieste', 'Brescia', 'Parma', 'Taranto', 'Prato', 'Modena'],
    'Japan': ['Tokyo', 'Tokyo', 'Tokyo', 'Yokohama', 'Osaka', 'Osaka', 'Nagoya', 'Sapporo', 'Kobe', 'Kyoto', 'Kyoto', 'Kyoto', 'Nara', 'Nara', 'Nara', 'Fukuoka', 'Kawasaki', 'Saitama', 'Hiroshima', 'Sendai', 'Kitakyushu', 'Chiba', 'Sakai', 'Niigata', 'Hamamatsu', 'Shizuoka', 'Sagamihara', 'Okayama'],
    ...
    'Kenya': ['Nairobi', 'Mombasa', 'Nairobi', 'Mombasa', 'Nairobi', 'Mombasa', 'Nakuru', 'Eldoret', 'Kisumu', 'Thika', 'Malindi', 'Kitale', 'Garissa', 'Kakamega'],
    ...
    'Latvia': ['Riga', 'Riga', 'Riga', 'Daugavpils', 'Liepaja'],
    'Lebanon': ['Beirut', 'Tripoli', 'Sidon'],
    'Liberia': ['Monrovia', 'Gbarnga', 'Bensonville'],
    'Libya': ['Tripoli', 'Benghazi', 'Misrata'],
    'Lithuania': ['Vilnius', 'Kaunas', 'Vilnius', 'Kaunas', 'Klaipeda'],
    'Luxembourg': ['Luxembourg City', 'Luxembourg City', 'Luxembourg City', 'Esch-sur-Alzette', 'Dudelange'],
    'Madagascar': ['Antananarivo'],
    'Malaysia': ['Kuala Lumpur', 'Kuala Lumpur', 'Kuala Lumpur', 'Johor Bahru', 'Ipoh', 'Kuching', 'Petaling Jaya', 'Shah Alam', 'Kota Kinabalu', 'Sandakan', 'Seremban', 'Kuantan'],
    ...
    'Mexico': ['Mexico City', 'Mexico City', 'Ecatepec', 'Guadalajara', 'Puebla', 'Ciudad Juarez', 'Tijuana', 'Ciudad Nezahualcoyotl', 'Monterrey', 'Leon', 'Zapopan', 'Naucalpan', 'Merida', 'Tlalnepantla', 'Chihuahua', 'San Luis Potosi', 'Aguascalientes', 'Hermosillo', 'Saltillo', 'Mexicali', 'Culiacan'],
    ...
    'Nepal': ['Kathmandu', 'Kathmandu', 'Kathmandu', 'Pokhara', 'Patan', 'Biratnagar', 'Birganj', 'Dharan', 'Bharatpur', 'Janakpur', 'Dhangadhi', 'Butwal'],
    'Netherlands': ['Amsterdam', 'Amsterdam', 'Amsterdam', 'Rotterdam', 'The Hague', 'Utrecht', 'Eindhoven', 'Tilburg'],
    'New Zealand': ['Auckland', 'Wellington', 'Christchurch', 'Auckland', 'Wellington', 'Christchurch', 'Auckland', 'Wellington', 'Christchurch', 'Manukau', 'Waitakere', 'North Shore', 'Hamilton', 'Dunedin', 'Tauranga', 'Lower Hutt'],
    ...
    'Norway': ['Oslo', 'Bergen', 'Oslo', 'Bergen', 'Oslo', 'Bergen', 'Trondheim', 'Stavanger', 'Drammen', 'Fredrikstad', 'Kristiansand', 'Sandnes', 'Tromso', 'Sarpsborg'],
    ...
    'Peru': ['Lima', 'Lima', 'Lima', 'Arequipa', 'Callao', 'Trujillo', 'Chiclayo', 'Iquitos', 'Huancayo', 'Piura', 'Chimbote', 'Cusco'],
    ...
    'Portugal': ['Lisbon', 'Porto', 'Lisbon', 'Porto', 'Lisbon', 'Porto', 'Amadora', 'Braga', 'Setubal', 'Coimbra', 'Queluz', 'Funchal', 'Cacem', 'Vila Nova de Gaia'],
    'Qatar': ['Doha', 'Ar Rayyan', 'Umm Salal Muhammad'],
    'Romania': ['Bucharest', 'Iasi', 'Cluj-Napoca', 'Timisoara', 'Craiova', 'Constanta'],
    'Russia': ['Moscow', 'Saint Petersburg', 'Moscow', 'Saint Petersburg', 'Moscow', 'Saint Petersburg', 'Novosibirsk', 'Yekaterinburg', 'Nizhny Novgorod', 'Samara', 'Omsk', 'Kazan', 'Chelyabinsk', 'Rostov-on-Don'],
    'Rwanda': ['Kigali', 'Kigali', 'Kigali', 'Butare', 'Gitarama', 'Ruhengeri', 'Gisenyi', 'Byumba', 'Cyangugu', 'Kibuye', 'Kibungo', 'Nzega'],
    'Saudi Arabia': ['Riyadh', 'Jeddah', 'Mecca', 'Medina', 'Riyadh', 'Jeddah', 'Mecca', 'Medina', 'Al-Ahsa', 'Ta\'if', 'Dammam', 'Buraydah', 'Khobar', 'Tabuk'],
    ...
    'Singapore': ['Singapore'],
    'Slovakia': ['Bratislava', 'Bratislava', 'Bratislava', 'Kosice', 'Presov', 'Nitra', 'Zilina', 'Banska Bystrica', 'Poprad'],
    'Slovenia': ['Ljubljana', 'Ljubljana', 'Ljubljana', 'Maribor', 'Celje', 'Kranj', 'Kranj', 'Velenje'],
    'Somalia': ['Mogadishu'],
    'South Africa': ['Cape Town', 'Durban', 'Johannesburg', 'Cape Town', 'Durban', 'Johannesburg', 'Soweto', 'Pretoria', 'Port Elizabeth', 'Pietermaritzburg', 'Benoni', 'Tembisa', 'Vereeniging'],
    'South Korea': ['Seoul', 'Seoul', 'Seoul', 'Busan', 'Busan', 'Incheon', 'Daegu', 'Daejeon', 'Gwangju', 'Suwon', 'Ulsan', 'Goyang', 'Seongnam'],
    'Spain': ['Madrid', 'Barcelona', 'Valencia', 'Seville', 'Madrid', 'Barcelona', 'Valencia', 'Seville', 'Zaragoza', 'Malaga', 'Murcia', 'Palma', 'Las Palmas de Gran Canaria', 'Bilbao', 'Alicante', 'Cordoba', 'Valladolid', 'Vigo', 'Gijon', 'L\'Hospitalet de Llobregat', 'A Coruna', 'Granada', 'Vitoria-Gasteiz', 'Santa Cruz de Tenerife', 'Badalona', 'Oviedo', 'Mataro', 'Elche', 'Terrassa', 'Jerez de la Frontera', 'Sabadell', 'Alcala de Henares', 'Pamplona', 'Fuenlabrada', 'Almeria', 'San Sebastian', 'Leganés', 'Cadiz', 'Segovia'],
    'Sri Lanka': ['Colombo', 'Colombo', 'Colombo', 'Galkissa', 'Moratuwa', 'Jaffna', 'Negombo', 'Pita Kotte', 'Sri Jayewardenepura Kotte', 'Kandy', 'Trincomalee', 'Kalmunai'],
    'Sudan': ['Khartoum', 'Omdurman', 'Port Sudan', 'Kassala', 'Al-Ubayyid', 'Kusti', 'Wad Madani', 'El Obeid', 'El Geneina', 'Ad-Damazin'],
    'Sweden': ['Stockholm', 'Gothenburg', 'Stockholm', 'Gothenburg', 'Stockholm', 'Gothenburg', 'Malmo', 'Uppsala', 'Vasteras'],
    'Switzerland': ['Zurich', 'Geneva', 'Zurich', 'Geneva', 'Basel', 'Lausanne', 'Bern', 'Winterthur', 'Lucerne', 'St. Gallen', 'Lugano', 'Biel/Bienne'],
    ...
    'Thailand': ["Bangkok", "Bangkok", "Bangkok", "Nonthaburi", "Samut Prakan", "Chiang Mai", "Udon Thani", "Nakhon Ratchasima", "Hat Yai", "Pak Kret", "Si Racha", "Phra Pradaeng", "Lampang", "Khon Kaen", "Surat Thani", "Nakhon Si Thammarat", "Ubon Ratchathani", "Pattaya", "Nakhon Sawan", "Chiang Rai", "Songkhla", "Phitsanulok"],
    'Togo': ['Lome', 'Sokode', 'Kara'],
    'Tunisia': ['Tunis', 'Sfax', 'Sousse'],
    'Turkey': ['Istanbul', 'Istanbul', 'Istanbul', 'Ankara', 'Izmir', 'Bursa', 'Adana', 'Gaziantep', 'Konya', 'Cankaya', 'Antalya', 'Bagcilar'],
    'Turkmenistan': ['Ashgabat', 'Ashgabat', 'Turkmenabat', 'Dasoguz', 'Mary', 'Balkanabat'],
    'Uganda': ['Kampala', 'Gulu', 'Lira', 'Mbarara', 'Jinja', 'Bwizibwera'],
    'Ukraine': ['Kiev', 'Kiev', 'Kiev', 'Kharkiv', 'Dnipro', 'Odessa', 'Donetsk', 'Zaporizhia', 'Lviv', 'Kryvyi Rih', 'Mykolaiv', 'Mariupol'],
    'United Arab Emirates': ['Dubai', 'Abu Dhabi', 'Dubai', 'Abu Dhabi', 'Dubai', 'Abu Dhabi', 'Sharjah', 'Al Ain'],
    'United Kingdom': ['London', 'London', 'London', 'Birmingham', 'Glasgow', 'Liverpool', 'Leeds', 'Sheffield', 'Edinburgh', 'Bristol', 'Manchester', 'Leicester', 'Coventry', 'Kingston upon Hull', 'Bradford', 'Cardiff', 'Belfast', 'Stoke-on-Trent', 'Wolverhampton', 'Plymouth', 'Nottingham', 'Southampton', 'Reading', 'Derby', 'Dudley', 'Newcastle upon Tyne', 'Northampton', 'Portsmouth', 'Luton', 'Preston', 'Aberdeen', 'Milton Keynes', 'Sunderland', 'Norwich', 'Walsall', 'Swansea', 'Bournemouth', 'Southend-on-Sea', 'Swindon', 'Oxford', 'Dundee', 'Poole', 'Huddersfield', 'York', 'Ipswich', 'Blackpool', 'Middlesbrough', 'Bolton', 'Peterborough', 'Stockport', 'Brighton'],
    'United States': ['New York', 'Los Angeles', 'Chicago', 'New York', 'Los Angeles', 'Chicago', 'New York', 'Los Angeles', 'Chicago', 'Houston', 'Phoenix', 'Philadelphia', 'San Antonio', 'San Diego', 'Dallas', 'San Jose', 'Austin', 'Jacksonville', 'Fort Worth', 'Columbus', 'San Francisco', 'Charlotte', 'Indianapolis', 'Seattle', 'Denver', 'Washington', 'Boston', 'El Paso', 'Nashville', 'Detroit', 'Oklahoma City', 'Portland', 'Las Vegas', 'Memphis', 'Louisville', 'Baltimore', 'Milwaukee', 'Albuquerque', 'Tucson', 'Fresno', 'Sacramento', 'Mesa', 'Kansas City', 'Atlanta', 'Long Beach', 'Omaha', 'Raleigh', 'Colorado Springs', 'Miami', 'Virginia Beach', 'Oakland', 'Minneapolis', 'Tulsa', 'Arlington', 'New Orleans', 'Wichita'],
    'Uruguay': ['Montevideo', 'Montevideo', 'Montevideo', 'Salto', 'Paysandu', 'Las Piedras'],
    'Uzbekistan': ['Tashkent', 'Tashkent', 'Tashkent', 'Namangan', 'Samarkand', 'Andijan', 'Nukus'],
    'Venezuela': ['Caracas', 'Maracaibo', 'Maracay', 'Valencia', 'Puerto La Cruz', 'Petare'],
    'Vietnam': ['Ho Chi Minh City', 'Hanoi', 'Ho Chi Minh City', 'Hanoi', 'Ho Chi Minh City', 'Hanoi', 'Haiphong', 'Da Nang', 'Bien Hoa', 'Hue', 'Nha Trang', 'Can Tho', 'Rach Gia', 'Quy Nhon'],
