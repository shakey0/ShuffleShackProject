...
class RegisterForm(FlaskForm):
    ...
    thirty_years_ago = today - datetime.timedelta(days=30*365.25)
    ...
    date_of_birth = DateField('Date of Birth', validators=[InputRequired(message='Please enter your date of birth.')], render_kw={"placeholder": "Date of Birth"}, default=thirty_years_ago)
